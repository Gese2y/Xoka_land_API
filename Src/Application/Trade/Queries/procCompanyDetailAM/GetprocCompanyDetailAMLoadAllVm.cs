...
namespace Application.Trade.Quiries.procCompanyDetailAM
{
    public class GetprocCompanyDetailAMLoadAllVm : IMapFrom<CompanyDetailAM>
    {
        ...
        {
            profile.CreateMap<CompanyDetailAM, GetprocCompanyDetailAMLoadAllVm>();
        }
    }
}
