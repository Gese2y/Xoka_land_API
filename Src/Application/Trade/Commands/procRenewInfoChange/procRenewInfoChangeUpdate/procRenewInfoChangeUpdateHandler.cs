...
namespace Application.Trade.Commands.procRenewInfoChange.procRenewInfoChangeUpdate.procRenewInfoChangeUpdateCommand
{

    /// @author  Shimels Alem  proc_Renew_Info_ChangeUpdate stored procedure.


    public class procRenewInfoChangeUpdateHandler : IRequestHandler<procRenewInfoChangeUpdateCommand, IList<RenewInfoChange_ChangeID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public procRenewInfoChangeUpdateHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<RenewInfoChange_ChangeID>> Handle( procRenewInfoChangeUpdateCommand request, CancellationToken cancellationToken)
        {
			...
			IList<RenewInfoChange_ChangeID> result = await _procedureAdabter
                .Execute<RenewInfoChange_ChangeID>("[Trade].proc_Renew_Info_ChangeUpdate",
