...
namespace Application.UnEmployment.Commands.procUnEmployee.procUnEmployeeInsert.procUnEmployeeInsertCommand
{

    /// @author  Shimels Alem  proc_UnEmployeeInsert stored procedure.


    public class procUnEmployeeInsertHandler : IRequestHandler<procUnEmployeeInsertCommand, IList<UnEmployee_TIN>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public procUnEmployeeInsertHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<UnEmployee_TIN>> Handle( procUnEmployeeInsertCommand request, CancellationToken cancellationToken)
        {
        ...
        IList<UnEmployee_TIN> result = await _procedureAdabter
                    .Execute<UnEmployee_TIN>("[UnEmployment].proc_UnEmployeeInsert",
                    (nameof(TIN), TIN),
