...
namespace Application.UnEmployment.Commands.procunEmployeeRequest.procunEmployeeRequestUpdate.procunEmployeeRequestUpdateCommand
{

    /// @author  Shimels Alem proc_unEmployeeRequestUpdate stored procedure.


    public class procunEmployeeRequestUpdateHandler : IRequestHandler<procunEmployeeRequestUpdateCommand, IList<unEmployeeRequest_Id>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public procunEmployeeRequestUpdateHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<unEmployeeRequest_Id>> Handle( procunEmployeeRequestUpdateCommand request, CancellationToken cancellationToken)
        {
            ...
            IList<unEmployeeRequest_Id> result = await _procedureAdabter
                .Execute<unEmployeeRequest_Id>("[UnEmployment].[proc_unEmployeeRequestUpdate]",
                (nameof(Id), Id),
                (nameof(TIN), TIN),
