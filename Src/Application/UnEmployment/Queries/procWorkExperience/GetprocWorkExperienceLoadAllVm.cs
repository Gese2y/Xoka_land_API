...
namespace Application.UnEmployment.Quiries.procWorkExperience
{
    public class GetprocWorkExperienceLoadAllVm : IMapFrom<WorkExperience>
    {
        ...
        {
            profile.CreateMap<WorkExperience, GetprocWorkExperienceLoadAllVm>();
        }
    }
}
