...
namespace Application.OCAC.Quiries.procView_Exam_Result_Certificat
{
    public class GetprocView_Exam_Result_CertificatLoadAllVm : IMapFrom<View_Exam_Result_Certificat>
    {
        ...
        {
            profile.CreateMap<View_Exam_Result_Certificat, GetprocView_Exam_Result_CertificatLoadAllVm>();
        }
    }
}
