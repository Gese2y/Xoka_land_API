...
{
    public class GetprocShareHolderDetailLoadAllviewVm : IMapFrom<ShareHolderDetailview>
    {
        ...
        {
            profile.CreateMap<ShareHolderDetailview, GetprocShareHolderDetailLoadAllviewVm>();
        }
    }
}
