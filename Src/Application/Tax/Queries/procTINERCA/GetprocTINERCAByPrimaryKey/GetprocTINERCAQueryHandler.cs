...
{
    public class GetprocTINERCAQueryHandler : IRequestHandler<GetprocTINERCAByPrimaryKey, GetprocTINERCALoadAllListVm>
    {
        ...
        public async Task<GetprocTINERCALoadAllListVm> Handle(GetprocTINERCAByPrimaryKey request, CancellationToken cancellationToken)
        {
           
            IList<TINERCA> procTINERCAs = await _procedureAdabter
               .Execute<TINERCA>("[Tax].[proc_TIN_ERCALoadByPrimaryKey]", request);
