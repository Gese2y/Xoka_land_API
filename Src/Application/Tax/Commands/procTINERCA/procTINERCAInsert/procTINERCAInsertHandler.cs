...
namespace Application.Tax.Commands.procTINERCA.procTINERCAInsert.procTINERCAInsertCommand
{

    /// @author  Shimels Alem  proc_TIN_ERCAInsert stored procedure.


    public class procTINERCAInsertHandler : IRequestHandler<procTINERCAInsertCommand, IList<TINERCA_TIN>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public procTINERCAInsertHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<TINERCA_TIN>> Handle( procTINERCAInsertCommand request, CancellationToken cancellationToken)
        {
            ...
            IList<TINERCA_TIN> result = await _procedureAdabter
                    .Execute<TINERCA_TIN>("[Tax].proc_TIN_ERCAInsert",
                    (nameof(TIN), TIN),
