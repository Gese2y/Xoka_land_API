...
namespace Application.Tax.Commands.procEmployeeTINInfo.procEmployeeTINInfoUpdate.procEmployeeTINInfoUpdateCommand
{

    /// @author  Shimels Alem  proc_Employee_TIN_InfoUpdate stored procedure.


    public class procEmployeeTINInfoUpdateHandler : IRequestHandler<procEmployeeTINInfoUpdateCommand, IList<EmployeeTINInfo_EmpTINID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public procEmployeeTINInfoUpdateHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<EmployeeTINInfo_EmpTINID>> Handle( procEmployeeTINInfoUpdateCommand request, CancellationToken cancellationToken)
        {
            ...
            IList<EmployeeTINInfo_EmpTINID> result = await _procedureAdabter
                .Execute<EmployeeTINInfo_EmpTINID>("[Tax].proc_Employee_TIN_InfoUpdate",
