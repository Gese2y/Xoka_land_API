...
{
    public class GetprocEnterpriseRegistrationLoadAllVm : IMapFrom<EnterpriseRegistration>
    {
        ...
        {
            profile.CreateMap<EnterpriseRegistration, GetprocEnterpriseRegistrationLoadAllVm>();
        }
    }
}
