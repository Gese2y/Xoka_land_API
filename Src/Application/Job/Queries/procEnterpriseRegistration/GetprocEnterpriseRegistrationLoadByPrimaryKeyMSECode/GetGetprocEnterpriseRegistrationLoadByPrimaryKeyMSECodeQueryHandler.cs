...
{
    public class GetprocEnterpriseRegistrationQueryHandler : IRequestHandler<GetprocEnterpriseRegistrationLoadByPrimaryKeyMSECode, GetprocEnterpriseRegistrationLoadAllListVm>
    {
        ...
        public async Task<GetprocEnterpriseRegistrationLoadAllListVm> Handle(GetprocEnterpriseRegistrationLoadByPrimaryKeyMSECode request, CancellationToken cancellationToken)
        {
           
            IList<EnterpriseRegistration> procEnterpriseRegistrations = await _procedureAdabter
               .Execute<EnterpriseRegistration>("[Job].[proc_Enterprise_RegistrationLoadByPrimaryKey_MSE_Code]", request);
