...
namespace Application.Job.Quiries.procbussinessRelationMKT
{
    public class GetprocbussinessRelationMKTLoadAllVm : IMapFrom<bussinessRelationMKT>
    {
        ...
        {
            profile.CreateMap<bussinessRelationMKT, GetprocbussinessRelationMKTLoadAllVm>();
        }
    }
}
