...
{
    public class GetprocSub_City_Job_Assignment_TransactionQueryHandler : IRequestHandler<Getproc_Sub_City_Job_Assignment_TransactionLoadByPrimaryKeyforsubcity, GetprocSub_City_Job_Assignment_TransactionLoadAllListVm>
    {
        ...
        public async Task<GetprocSub_City_Job_Assignment_TransactionLoadAllListVm> Handle(Getproc_Sub_City_Job_Assignment_TransactionLoadByPrimaryKeyforsubcity request, CancellationToken cancellationToken)
        {
           
            IList<Sub_City_Job_Assignment_Transaction> procSub_City_Job_Assignment_Transactions = await _procedureAdabter
               .Execute<Sub_City_Job_Assignment_Transaction>("[Job].[proc_Sub_City_Job_Assignment_TransactionLoadByPrimaryKeyforsubcity]", request);
