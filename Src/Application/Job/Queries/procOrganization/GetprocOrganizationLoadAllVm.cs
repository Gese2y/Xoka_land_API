...
namespace Application.Job.Quiries.procOrganization
{
    public class GetprocOrganizationLoadAllVm : IMapFrom<Organization>
    {
        ...
        {
            profile.CreateMap<Organization, GetprocOrganizationLoadAllVm>();
        }
    }
}
