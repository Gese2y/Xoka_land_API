...
namespace Application.Job.Commands.procBussRelationInput.procBussRelationInputUpdate.procBussRelationInputUpdateCommand
{

    /// @author  Shimels Alem  proc_Buss_Relation_InputUpdate stored procedure.


    public class procBussRelationInputUpdateHandler : IRequestHandler<procBussRelationInputUpdateCommand, IList<BussRelationInput_ID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public procBussRelationInputUpdateHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<BussRelationInput_ID>> Handle( procBussRelationInputUpdateCommand request, CancellationToken cancellationToken)
        {
            ...
            IList<BussRelationInput_ID> result = await _procedureAdabter
                .Execute<BussRelationInput_ID>("[Job].proc_Buss_Relation_InputUpdate", (nameof(ID), ID),
