...
namespace Application.Job.Commands.procEducation.procEducationUpdate.procEducationUpdateCommand
{
    ...
    public class procEducationUpdateHandler : IRequestHandler<procEducationUpdateCommand, IList<Education_ID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public procEducationUpdateHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<Education_ID>> Handle( procEducationUpdateCommand request, CancellationToken cancellationToken)
        {
           ...
           string Eduction_Types = request.Eduction_Types;
            IList<Education_ID> result = await _procedureAdabter
                .Execute<Education_ID>("[Job].proc_EducationUpdate",
                (nameof(ID), ID),
