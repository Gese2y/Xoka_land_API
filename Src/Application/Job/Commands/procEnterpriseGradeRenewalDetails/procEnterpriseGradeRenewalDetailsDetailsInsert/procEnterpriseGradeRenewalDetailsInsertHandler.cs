...
namespace Application.Job.Commands.procEnterpriseGradeRenewalDetails.procEnterpriseGradeRenewalDetailsInsert.procEnterpriseGradeRenewalDetailsInsertCommand
{
    ...
    public class procEnterpriseGradeRenewalDetailsInsertHandler : IRequestHandler<procEnterpriseGradeRenewalDetailsInsertCommand, IList<Enterprise_Grade_Renewal_Details_ID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public procEnterpriseGradeRenewalDetailsInsertHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }
        public async Task<IList<Enterprise_Grade_Renewal_Details_ID>> Handle(procEnterpriseGradeRenewalDetailsInsertCommand request, CancellationToken cancellationToken)
        {
            ...
            IList<Enterprise_Grade_Renewal_Details_ID> result = await _procedureAdabter
                    .Execute<Enterprise_Grade_Renewal_Details_ID>("[dbo].[proc_Enterprise_Grade_Renewal_DetailsInsert]",
