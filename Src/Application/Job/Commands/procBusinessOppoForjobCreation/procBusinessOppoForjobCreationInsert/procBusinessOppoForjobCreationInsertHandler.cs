...
namespace Application.Job.Commands.procBusinessOppoForjobCreation.procBusinessOppoForjobCreationInsert.procBusinessOppoForjobCreationInsertCommand
{

    /// @author  Shimels Alem  proc_Business_Oppo_For__job_CreationInsert stored procedure.


    public class procBusinessOppoForjobCreationInsertHandler : IRequestHandler<procBusinessOppoForjobCreationInsertCommand, IList<BusinessOppoForjobCreation_BUSOPPID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public procBusinessOppoForjobCreationInsertHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<BusinessOppoForjobCreation_BUSOPPID>> Handle( procBusinessOppoForjobCreationInsertCommand request, CancellationToken cancellationToken)
        {
            ...
            IList<BusinessOppoForjobCreation_BUSOPPID> result = await _procedureAdabter
                .Execute<BusinessOppoForjobCreation_BUSOPPID>("[Job].proc_Business_Oppo_For__job_CreationInsert",
                 (nameof(BUS_OPP_ID), BUS_OPP_ID),
                 (nameof(Code), Code),
                 (nameof(Name), Name),
