...
namespace Application.Job.Commands.procbussinessRelationMKT.procbussinessRelationMKTInsert.procbussinessRelationMKTInsertCommand
{
    ...
    public class procbussinessRelationMKTInsertHandler : IRequestHandler<procbussinessRelationMKTInsertCommand, IList<bussinessRelationMKT_ID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public procbussinessRelationMKTInsertHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<bussinessRelationMKT_ID>> Handle( procbussinessRelationMKTInsertCommand request, CancellationToken cancellationToken)
        {
           ...
           IList<bussinessRelationMKT_ID> result = await _procedureAdabter
                .Execute<bussinessRelationMKT_ID>("[Job].proc_bussiness_Relation_MKTInsert",
                (nameof(ID), ID),
