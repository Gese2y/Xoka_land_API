...
namespace Application.Job.Commands.procJobSeeker.procJobSeekerInsert.procJobSeekerInsertCommand
{
    ...
    public class procJobSeekerInsertHandler : IRequestHandler<procJobSeekerInsertCommand, IList<JobSeeker_ID>>
    {
        readonly IMapper _mapper;
        readonly IProcedureAdabter _procedureAdabter;
        public procJobSeekerInsertHandler(IMapper mapper, IProcedureAdabter procedureAdabter)
        {
            _mapper = mapper;
            _procedureAdabter = procedureAdabter;
        }

        public async Task<IList<JobSeeker_ID>> Handle( procJobSeekerInsertCommand request, CancellationToken cancellationToken)
        {
        ...
        IList<JobSeeker_ID> result = await _procedureAdabter
                .Execute<JobSeeker_ID>("[Job].proc_Job_SeekerInsert",
                    (nameof(ID), ID),
                    (nameof(TIN), TIN),
